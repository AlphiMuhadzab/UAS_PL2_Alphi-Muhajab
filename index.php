    ...
    <div class="container">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 ml-9 mt-5 ">
                <button type="button" class="btn btn-primary mb-2"><a class="text-white" href="inputIndex.php?id=<?php ?>">Penambahan Data Buku Perpustakaan</a></button>
                    <table class="table table-hover shadow-lg bg-body rounded">
                        ...
                        <?php
                            include 'koneksi.php';
                            $data = mysqli_query ($koneksi,"SELECT * FROM tb_data_buku");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success"><a class="text-white" href="updateIndex.php?id=<?php echo $d['id']?>">Update</a></button>
                                    <button type="button" class="btn btn-danger"><a class="text-white" href="deleteIndex.php?id=<?php echo $d['id']?>">Delete</a></button>
                                </td>     
                            </tr>
                        <?php
                            }
